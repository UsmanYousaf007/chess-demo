    ...
    public abstract class ConfigBase : EditorWindow
    {
        ...
        protected void showConfiguration()
        {
            ...
            scrollPosConfig = EditorGUILayout.BeginScrollView(scrollPosConfig, false, false);
            {
                ...
                Util.Config.ENSURE_NAME = EditorGUILayout.Toggle(new GUIContent("Ensure Name", "Ensure the name of the OnlineCheck gameobject (default: " + Util.Constants.DEFAULT_ENSURE_NAME + ")."), Util.Config.ENSURE_NAME);
            }
