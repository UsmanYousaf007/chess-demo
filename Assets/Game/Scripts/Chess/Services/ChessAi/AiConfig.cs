...
namespace TurboLabz.Chess
{
    public static class AiConfig
    {
        ...
        public const string SLOW_MOVER = "10"; // This makes the engine think less. We use the minimum here because we want to max out performance.
        public const int DEFAULT_SEARCH_DEPTH = 0; // For now, keep things as fast as possible. Might increase this with difficulty (TODO).
        public const int ONE_MIN_SEARCH_DEPTH = 10; // Because we want the computer to be aggressive in 1 min games. Might change (TODO).
