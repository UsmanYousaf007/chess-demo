...
namespace TurboLabz.Gamebet
{
    public partial class GSService
    {
        ...
        private void OnChallengeTurnTakenMessage(ChallengeTurnTakenMessage message)
        {
            ...
            if (GSRecurringMessagePatch.isMessageRecurring(message, "GSService_GameMessages"))
            {
                return;
            }
            ...
            // We process data for remote turns received.
        ...
        private void LoadChessboardModel(GSData gameData)
        {
            ...
            if (gameDuration == GSBackendKeys.ROOM_1_DURATION)
            {
                chessboardModel.aiTimeControl = AiTimeControl.ONE_MINUTE;
            }
            else if (gameDuration == GSBackendKeys.ROOM_2_DURATION)
            {
                chessboardModel.aiTimeControl = AiTimeControl.THREE_MINUTE;
            }
            else if (gameDuration == GSBackendKeys.ROOM_3_DURATION)
            {
                chessboardModel.aiTimeControl = AiTimeControl.FIVE_MINUTE;
            }
            else if (gameDuration == GSBackendKeys.ROOM_4_DURATION)
            {
                chessboardModel.aiTimeControl = AiTimeControl.TEN_MINUTE;
            }
            ...
            chessboardModel.opponentLevel = matchInfoModel.opponentPublicProfile.level;
