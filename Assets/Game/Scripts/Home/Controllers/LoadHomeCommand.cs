...
{
    public class LoadHomeCommand : Command
    {
        ...
        [Inject] public UpdateHomeViewSignal updateHomeViewSignal { get; set; }
        ...
        public override void Execute()
        {
            ...
            navigatorEventSignal.Dispatch(NavigatorEvent.SHOW_HOME);

            HomeVO vo = new HomeVO(cpuGameModel, playerModel, metaDataModel);

            updateHomeViewSignal.Dispatch(vo);
