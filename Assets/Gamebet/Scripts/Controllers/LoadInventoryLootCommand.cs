...
/// @date 2018-02-23 11:41:31 UTC+05:00
...
{
    public class LoadInventoryLootCommand : Command
    {
        // Dispatch signals
        [Inject] public LoadViewSignal loadViewSignal { get; set; }
        [Inject] public UpdateInventoryLootViewSignal updateInventoryLootViewSignal { get; set; }
        ...
        public override void Execute()
        {
            ...
            viewStateModel.subInventoryViewId = SubInventoryViewId.LOOT;
            ...
            updateInventoryLootViewSignal.Dispatch(shopVo);
        }
    }
}
