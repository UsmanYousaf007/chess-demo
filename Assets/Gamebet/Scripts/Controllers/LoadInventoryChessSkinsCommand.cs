...
/// @date 2018-02-23 11:36:34 UTC+05:00

using strange.extensions.command.impl;

namespace TurboLabz.Gamebet
{
    public class LoadInventoryChessSkinsCommand : Command
    {
        // Dispatch signals
        [Inject] public LoadViewSignal loadViewSignal { get; set; }
        [Inject] public UpdateInventoryChessSkinsViewSignal updateInventoryChessSkinsViewSignal { get; set; }
        ...
        public override void Execute()
        {
            ...
            viewStateModel.subInventoryViewId = SubInventoryViewId.CHESSSKINS;
            ...
            updateInventoryChessSkinsViewSignal.Dispatch(shopVo);
        }
    }
}
