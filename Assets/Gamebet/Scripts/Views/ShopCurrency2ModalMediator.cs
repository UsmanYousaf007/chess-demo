...
/// @date 2018-02-28 12:35:29 UTC+05:00
...
{
    public class ShopCurrency2ModalMediator : Mediator
    {
        // View injection
        [Inject] public ShopCurrency2ModalView view { get; set; }
        ...
        [ListensTo(typeof(UpdateShopCurrency2ModalViewSignal))]
        ...
        {
            if (viewId == NavigatorViewId.SHOP_CURRENCY_2_DLG) 
            {
                view.Show();
            }
        }
