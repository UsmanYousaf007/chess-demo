...
/// @date 2018-02-15 16:48:52 UTC+05:00
...
{
    public class ShopChessSkinsModalMediator : Mediator
    {
        // View injection
        [Inject] public ShopChessSkinsModalView view { get; set; }
        ...
        public override void OnRemove()
        {
            ...
            purchaseAvatarsResultSignal.RemoveListener(OnPurchaseResult);
        }

        [ListensTo(typeof(UpdateShopChessSkinsModalViewSignal))]
        ...
        {
            if (viewId == NavigatorViewId.SHOP_CHESS_SKINS_DLG) 
            {
                view.Show();
            }
        }
