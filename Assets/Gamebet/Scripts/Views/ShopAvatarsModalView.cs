...
/// @date 2018-02-21 11:54:13 UTC+05:00
...
{
    public class ShopAvatarsModalView : View
    {
        ...
        public void UpdateView(ShopVO vo)
        {
            ...
            titleLabel.text = vo.shopSettings.avatarShopItems[vo.activeShopItemId].displayName;

            avatarImage.sprite = avatarThumbsContainer.GetThumb(vo.activeShopItemId).thumbnail;

            enoughBucksDialogueLabel.text = localizationService.Get(LocalizationKey.S_M_BUY_FOR_LABEL);
            enoughBucksBuyPriceLabel.text = vo.shopSettings.avatarShopItems[vo.activeShopItemId].currency2Cost.ToString();

            notEnoughBucksDialogueLabel.text = localizationService.Get(LocalizationKey.S_M_NOT_ENOUGH_BUCKS_LABEL);
            notEnoughBucksPriceLabel.text = vo.shopSettings.avatarShopItems[vo.activeShopItemId].currency2Cost.ToString();

            confirmationDialogueLabel.text = localizationService.Get(LocalizationKey.S_M_PURCHASE_AVATARS_FOR_LABEL,vo.shopSettings.avatarShopItems[vo.activeShopItemId].currency2Cost.ToString());
            ...
            addToCollectionDialogueLabel.text = localizationService.Get(LocalizationKey.S_M_BOUGHT_AVATARS_LABEL);
            ...
            else if (vo.playerModel.currency2 >= vo.shopSettings.avatarShopItems[vo.activeShopItemId].currency2Cost)
            {
