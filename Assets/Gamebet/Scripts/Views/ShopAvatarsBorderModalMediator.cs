...
/// @date 2018-02-21 13:28:24 UTC+05:00
...
{
    public class ShopAvatarsBorderModalMediator : Mediator
    {
        // View injection
        [Inject] public ShopAvatarsBorderModalView view { get; set; }
        ...
        [ListensTo(typeof(UpdateShopAvatarsBorderModalViewSignal))]
        ...
        {
            if (viewId == NavigatorViewId.SHOP_AVATARS_BORDER_DLG) 
            {
                view.Show();
            }
        }
