...
{
    public class SocialEdgeUnblockFriendResponse : SocialEdgeRequestResponse<SetFriendTagsResult, PlayFabError>
    {
        public string token;
    ...
    /// </summary>
    public class SocialEdgeUnblockFriendRequest : SocialEdgeRequest<SocialEdgeUnblockFriendRequest, SocialEdgeUnblockFriendResponse>
    {
        // Request parameters section
        public string friendId { get; set; }

        public SocialEdgeUnblockFriendRequest()
        {
            request = this;
        }
