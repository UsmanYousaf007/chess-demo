    ...
    public static class GDPRTranslationsProvider
    {
        ...
        static readonly List<GDPRTranslation> translations = new List<GDPRTranslation>
        {
            ...
            new GDPRTranslation
            {
                ...
                footer = "Klikając w OK powyżej, akceptujesz nasze <link=" + TERMS_OF_USE_LINK + "><color=#{0}><b><u>Warunki Korzystania</u></b></color></link> oraz <link=" + PRIVACY_POLICY_LINK + "><color=#{0}><b><u>Politykę Prywatności</u></b></color></link> oraz potwierdzasz ukończenie 16-ego roku życia.",
            ...
            new GDPRTranslation()
            {
                ...
                footer = @"Facendo clic su OK qui sopra, l'utente accetta di essere vincolato dalle nostre <link=" + TERMS_OF_USE_LINK + "><color=#{0}><b><u>Condizioni d'Uso</u></b></color></link> e dalla nostra <link=" + PRIVACY_POLICY_LINK + "><color=#{0}><b><u>Informativa sulla Privacy</u></b></color></link> e afferma di avere più di 16 anni.",
                toggle = "Acepto",
                button = "Okay"
            },
            ...
            new GDPRTranslation()
            {
                ...
                footer = @"Al hacer clic en Aceptar arriba, se acepta estar sujeto a nuestros <link=" + TERMS_OF_USE_LINK + "><color=#{0}><b><u>Términos de uso</u></b></color></link> y condiciones y nuestra <link=" + PRIVACY_POLICY_LINK + "><color=#{0}><b><u>Política de privacidad</u></b></color></link> y afirma que es mayor de 16 años.",
                toggle = "Acepto",
                button = "Okay"
            },
            ...
            new GDPRTranslation()
            {
                ...
                footer = @"Al hacer clic en Aceptar, accede a estar sujeto a nuestras <link=" + TERMS_OF_USE_LINK + "><color=#{0}><b><u>Condiciones de uso</u></b></color></link> y a nuestra <link=" + PRIVACY_POLICY_LINK + "><color=#{0}><b><u>Política de privacidad</u></b></color></link> y afirma que es mayor de 16 años.",
                toggle = "Aceptar",
                button = "OK"
            },
            ...
            new GDPRTranslation()
            {
                ...
                footer = @"本<link=" + TERMS_OF_USE_LINK + "><color=#{0}><b><u>規約</u></b></color></link>及び<link=" + PRIVACY_POLICY_LINK + "><color=#{0}><b><u>プライバシーポリシー</u></b></color></link>をお読みいただき、「同意する」ボタンを押してください。（同意した方は16歳以上と判断させていただきます）",
                toggle = "同意する",
                button = "OK"
            },
            ...
            new GDPRTranslation()
            {
                ...
                footer = @"En cliquant sur OK ci-dessus, vous acceptez nos <link=" + TERMS_OF_USE_LINK + "><color=#{0}><b><u>conditions d'utilisation</u></b></color></link>  et notre <link=" + PRIVACY_POLICY_LINK + "><color=#{0}><b><u>politique de confidentialité</u></b></color></link> et vous affirmez avoir plus de 16 ans.",
                toggle = "J'accepte",
                button = "OK"
            },
            ...
            new GDPRTranslation()
            {
                ...
                footer = @"Wenn du oben auf OK klickst, erklärst du dich mit unseren <link=" + TERMS_OF_USE_LINK + "><color=#{0}><b><u>Nutzungsbedingungen</u></b></color></link> und unserer <link=" + PRIVACY_POLICY_LINK + "><color=#{0}><b><u>Datenschutzrichtlinie</u></b></color></link> einverstanden und bestätigst, dass du älter als 16 Jahre bist.",
                toggle = "Ich nehme an",
                button = "OK"
            },
            ...
            new GDPRTranslation()
            {
                ...
                footer = @"위의 확인을 클릭함으로써 귀하는 당사의 <link=" + TERMS_OF_USE_LINK + "><color=#{0}><b><u>사용 약관</u></b></color></link> 및 당사의 <link=" + PRIVACY_POLICY_LINK + "><color=#{0}><b><u>개인정보보호 정책</u></b></color></link>의 적용을 받는 데 동의하게 되며 귀하가 16세를 초과한다는 것을 확인하게 됩니다.",
                toggle = "동의합니다.",
                button = "확인"
            },
            ...
            new GDPRTranslation()
            {
                ...
                footer = @"Ao clicar em OK acima, você concorda em estar ligado aos nossos <link=" + TERMS_OF_USE_LINK + "><color=#{0}><b><u>Termos de Uso</u></b></color></link> e a nossa <link=" + PRIVACY_POLICY_LINK + "><color=#{0}><b><u>Política de Privacidade</u></b></color></link> e você afirma que você tem mais de 16 anos.",
                toggle = "Eu aceito",
                button = "OK"
            },
            ...
            new GDPRTranslation()
            {
                ...
                footer = @"Ao clicar em OK acima, você concorda com o vínculo dos nossos <link=" + TERMS_OF_USE_LINK + "><color=#{0}><b><u>Termos de Uso</u></b></color></link> e nossa <link=" + PRIVACY_POLICY_LINK + "><color=#{0}><b><u>Política de Privacidade</u></b></color></link>, e confirma ter mais de 16 anos.",
                toggle = "Aceito",
                button = "OK"
            },
            ...
            new GDPRTranslation()
            {
                ...
                footer = @"Нажимая OK выше, ты соглашаешься с нашими <link=" + TERMS_OF_USE_LINK + "><color=#{0}><b><u>Условиями использования и</u></b></color></link> нашей <link=" + PRIVACY_POLICY_LINK + "><color=#{0}><b><u>Политикой Конфиденциальности</u></b></color></link>, и подтверждаешь, что тебе больше 16 лет.",
                toggle = "Я принимаю",
                button = "OK"
            },
            ...
            new GDPRTranslation()
            {
                ...
                footer = @"Ved å klikke på OK ovenfor godtar du å være bundet av våre <link=" + TERMS_OF_USE_LINK + "><color=#{0}><b><u>bruksvilkår</u></b></color></link> og vår <link=" + PRIVACY_POLICY_LINK + "><color=#{0}><b><u>personvernerklæring</u></b></color></link>, og du bekrefter at du er over 16 år.",
                toggle = "Jeg godtar",
                button = "OK"
            },
            ...
            new GDPRTranslation()
            {
                ...
                footer = @"Genom att klicka på OK ovan går du med på att följa våra <link=" + TERMS_OF_USE_LINK + "><color=#{0}><b><u>användarvillkor</u></b></color></link> och vår <link=" + PRIVACY_POLICY_LINK + "><color=#{0}><b><u>integritetspolicy</u></b></color></link>, samt bekräftar att du har fyllt 16 år.",
