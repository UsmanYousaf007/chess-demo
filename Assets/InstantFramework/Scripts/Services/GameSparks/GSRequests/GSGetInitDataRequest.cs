...
namespace TurboLabz.InstantFramework
{
    public class GSGetInitDataRequest : GSRequest
    {
        ...
        public IPromise<BackendResult> Send(int clientVersion, Action<LogEventResponse> successCallback)
        {
            GSRequestSession.Instance.AddRequest(this);
            this.successCallback = successCallback;
            new LogEventRequest().SetEventKey(GSEventData.GetInitData.EVT_KEY)
                .SetEventAttribute(GSEventData.GetInitData.EVT_APP_VERSION, clientVersion)
