...
{
    public class NSSubscriptionSaleDlg : NS
    {
        public override void RenderDisplayOnEnter()
        {
            ShowDialog(NavigatorViewId.SUBSCRIPTION_SALE_DLG);
        }
        ...
        public override NS HandleEvent(NavigatorEvent evt)
        {
            ...
            if (evt == NavigatorEvent.ESCAPE)
            {
                ...
                {
                    cmd.hideViewSignal.Dispatch(NavigatorViewId.SUBSCRIPTION_SALE_DLG);
