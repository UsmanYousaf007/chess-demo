...
/*
 * This method returns the function pointer of hsUnityMessageCallback type to C#
 */
extern "C" typedef void (*hsUnityMessageCallback)(const char *);
 ...
 * Listens to the delegates of ObjC.
 */
@interface HsSupportDelegate : NSObject <HelpshiftSupportDelegate>
