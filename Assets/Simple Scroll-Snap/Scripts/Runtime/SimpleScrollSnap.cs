...
namespace DanielLochner.Assets.SimpleScrollSnap
{
    ...
    public class SimpleScrollSnap : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler, IPointerDownHandler, IPointerUpHandler
    {
        ...
        private bool isForceInitialized;
        ...
        public int PreviousPanel { get; set; }
        ...
        private void SnapToTargetPanel()
        {
            ...
            Content.anchoredPosition = Vector2.Lerp(Content.anchoredPosition, targetPosition, skipLerp ? 1 : (useUnscaledTime ? Time.unscaledDeltaTime : Time.deltaTime) * snappingSpeed);
        ...
        public void GoToPanel(int panelNumber, bool skipLerp = false)
        {
            this.skipLerp = skipLerp;
            PreviousPanel = TargetPanel;
        ...
        public void GoToPreviousPanel(bool skipLerp = false)
        {
            this.skipLerp = skipLerp;
        ...
        public void GoToNextPanel(bool skipLerp = false)
        {
            this.skipLerp = skipLerp;
            NearestPanel = DetermineNearestPanel();
