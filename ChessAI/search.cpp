...
void MainThread::search() {
  ...
  */
  ...
  unityOut("bestmove " + UCI::move(bestThread->rootMoves[0].pv[0], rootPos.is_chess960()));
...
moves_loop: // When in check search starts from here
  ...
  Move Skill::pick_best(size_t multiPV) {
    ...
    std::string moveScores;
    moveOptions.append("moveOptions,");
    moveScores.append("moveScores,");
    ...
    for (size_t i = 0; i < multiPV; ++i)
    {
        ...
        moveOptions.append(UCI::move(rootMoves[i].pv[0], false));
        moveScores.append(std::to_string(rootMoves[i].score));
    }

    unityOut(moveOptions);
    unityOut(moveScores);
